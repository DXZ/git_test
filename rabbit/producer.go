...
var url = flag.String("url", "amqp://naga_user_dev:knowboxdev@10.10.213.219:5672/naga_devnaga_dev", "amqp url")
...
func main() {
	...
	pbl := cony.NewPublisher("", "testSeven")
	cli.Publish(pbl)
	...
	http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		if r.Method == "GET" {
			...
			fmt.Println("------body--------", r.FormValue("body"))
